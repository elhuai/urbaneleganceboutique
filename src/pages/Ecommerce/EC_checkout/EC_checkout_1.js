        ...
        <>
            <body className="Checkout_1">
                <div className="topRow">
                    <div className="step1">1.確認購物車內容&emsp;&emsp;&emsp;&emsp; ></div>
                            ...
                            <div className="infoColumn">
                                ...
                                <div className="subSection">
                                    ...
                                    <div className="subValue">
                                        優惠期間：自 2022 年 07 月 26 日 起兌換至 2022 年 09 月 30 日，週一至週日適用{' '}
                                        <br />
                                        ...
                                        CD方案可擇選場次 <br />
                                        1. 拂曉獨木舟：17:00 集合。享用晚餐、露營，並參加隔日獨木舟拂曉場次，約 09:00
                                        結束活動 <br />
                                        2. 下午獨木舟：13:00~13:30 集合。17:00 享用晚餐、露營，約隔日 07:00 結束活動{' '}
                                        <br />
                                    </div>
                                </div>
                                <div className="subSection">
                ...
                <div className='bottomRow'>
                  <Link to="/ec-checkout2"><button>確認商品資訊，下一步</button></Link>
