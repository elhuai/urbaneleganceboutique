        ...
        <section className="comList_section_main_bg">
          ...
          <div className="comList_main_search">
            ...
            <div className="comList_main_search_group input-group p-2 ">
              <input
                type="text"
                className="comList_search_input form-control"
                placeholder="狗罐罐"
              />
              <button
                className="comList_search_btn btn btn-primary"
                type="button"
                id="button-addon2"
              >
                <BsSearch />
                ...
                <div className="col-md-8">
                  <div className="card-body">
                    ...
                    <div className="comList_main_card_bottom_text card-text d-flex justify-content-between">
                      <p className="comList_main_card_locate_text card-text">
                        <IoLocationSharp />
                        花蓮
                      </p>
                      <p className="comList_main_card_like_text card-text">
                        1234 <BiLike />
                      </p>
                    </div>
                  </div>
