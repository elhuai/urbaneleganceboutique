...
import './_communitySwiperLeft.scss';

const fakeData = [
  {
    title: '故事的小黃花',
    img: 'https://picsum.photos/id/123/600/300',
    author: '黑松沙士比亞',
    like: '1234',
  },
  {
    title: '從出生那年就飄著',
    img: 'https://picsum.photos/id/223/600/300',
    author: '雪碧不見面',
    like: '2234',
  },
  {
    title: '童年的盪鞦韆',
    img: 'https://picsum.photos/id/323/600/300',
    author: '可口可樂果尚酥',
    like: '3234',
  },
  {
    title: '隨記憶一直晃到現在',
    img: 'https://picsum.photos/id/43/600/300',
    author: '蘋果西打咩唷',
    like: '4234',
  },
  {
    title: '吹著前奏望著天空',
    img: 'https://picsum.photos/id/54/600/300',
    author: '七喜咧哈囉',
    like: '5234',
  },
  {
    title: '我想起花瓣試著掉落',
    img: 'https://picsum.photos/id/26/600/300',
    author: '分達美樂披薩',
    like: '6234',
  },
];
              ...
              <Link to="/" className="communitySwiper_card d-flex flex-column">
                ...
                <div className="d-flex flex-fill flex-column p-3">
                  ...
                  <div className="communitySwiper_card_info d-flex justify-content-between align-items-end">
                    ...
                    <div className="communitySwiper_card_like">{data.like}</div>
                  </div>
                </div>
              </Link>
            </SwiperSlide>
