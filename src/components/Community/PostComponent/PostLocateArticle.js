...
import PhotoReviewSwiper from '../../WYSIWYG/PhotoViewDefault';

function PostLocateArticle() {
  return (
    <ul className="article_section">
      ...
      <li className="trip_record_section" id="locate2">
        ...
        <p>
          ✍🏻天氣太熱～ 真的是車遊太魯閣 從頭到尾沒有下車 緩慢的速度欣賞沿途風景
        </p>
        <PhotoReviewSwiper></PhotoReviewSwiper>
        <hr></hr>
      </li>
      <li className="trip_record_section" id="locate3">
        ...
        <p>
          ✍🏻這次第一天其實是住親戚家 用前年住過的煙波來替代地點 煙波的浴缸也很棒
          離市區也很近 有山景跟海景房可以選擇 （挑選住宿的條件一定要有大浴缸！）
        </p>
        <PhotoReviewSwiper></PhotoReviewSwiper>
        <hr></hr>
      </li>
      ...
      <li className="trip_record_section" id="locate5">
        <div className="post_location_mark">
          <p>
            <MdLocationOn className="mb-1 me-1"></MdLocationOn>1.5小時 | 依山午
          </p>
        </div>
        <p>
          這次的住宿真的超級滿意！ 很幸運的住到一樓 陽台外可以餵魚
          特別喜歡它的浴缸！二個人一起泡位置也很大 帶了最喜歡的LUSH泡澡球跟白酒
          超放鬆～ 園區也很美很漂亮🌸🌸🌸🌸✨
        </p>
        <PhotoReviewSwiper></PhotoReviewSwiper>
        <hr></hr>
      ...
      <li className="trip_record_section" id="locate7">
        ...
        <p>
          顆顆顆 南濱公園這次去沒什麼人 海景很漂亮但是風很大 這是最後的行程
          再來就要回台北囉～
        </p>
        <PhotoReviewSwiper></PhotoReviewSwiper>
        <hr></hr>
...
export default PostLocateArticle;
